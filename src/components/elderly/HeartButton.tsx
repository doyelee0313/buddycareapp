...
export function HeartButton({ onSend, caregiverName }: HeartButtonProps) {
  ...
  return (
    <>
      ...
      {/* Heart button with translucent label */}
      <div className="fixed bottom-24 right-4 z-40 flex flex-col items-center">
        <motion.button
          className="heart-button w-18 h-18 flex flex-col items-center justify-center relative"
          onClick={handleClick}
        ...
        {/* Translucent text below button */}
        <p className="text-xs text-muted-foreground/60 mt-1 text-center whitespace-nowrap">
          Send love 💕
        </p>
      </div>
    </>
